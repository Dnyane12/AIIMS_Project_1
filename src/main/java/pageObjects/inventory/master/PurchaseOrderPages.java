...
@FindBy(xpath="//span[contains(normalize-space(.),'Purchase Order') and contains(@class,'fs-12')]")
...
public void selectSeries(String option) {	
	...
	WaitHelper.waitForClickable(driver, seriesOptField, 10);
...
public void setSeriesDropdownField(WebElement SeriesDropdownField) {
	SeriesDropdownField = SeriesDropdownField;
}



public WebElement getPartyDropdown() {
	return partyDropdown;
}



public void setPartyDropdown(WebElement partyDropdown) {
	this.partyDropdown = partyDropdown;
}
...
public void setDispatchModeDropdown(WebElement dispatchModeDropdown) {
	this.dispatchModeDropdown = dispatchModeDropdown;
}
...
public void setDeliveryAt(WebElement deliveryAt) {
...
public void setDeliveryPoint(WebElement deliveryPoint) {
...
public void setPreferredTransporter(WebElement preferredTransporter) {
	PreferredTransporter = preferredTransporter;
}
...
public void setItemDropdown(WebElement itemDropdown) {
...
public void setRate(WebElement rate) {
	this.rate = rate;
}
...
public void setTermsAndConDrop(WebElement termsAndConDrop) {
	this.termsAndConDrop = termsAndConDrop;
}
...
public void setAddButtonTerConTab(WebElement addButtonTerConTab) {
	this.addButtonTerConTab = addButtonTerConTab;
}
...
public void setPaymentTermDrop(WebElement paymentTermDrop) {
	this.paymentTermDrop = paymentTermDrop;
}
...
public void setPkgForward(WebElement pkgForward) {
	this.pkgForward = pkgForward;
}
...
public void setAddButtonItemDtl(WebElement addButtonItemDtl) {
	this.addButtonItemDtl = addButtonItemDtl;
}
...
public void setPaymentTermAddBtn(WebElement paymentTermAddBtn) {
	this.paymentTermAddBtn = paymentTermAddBtn;
}
...
public void setResetBtnPayTerm(WebElement resetBtnPayTerm) {
	this.resetBtnPayTerm = resetBtnPayTerm;
}
...
public void setResetBtnItemDtl(WebElement resetBtnItemDtl) {
	this.resetBtnItemDtl = resetBtnItemDtl;
}
...
public void setItemDtlTab(WebElement itemDtlTab) {
	this.itemDtlTab = itemDtlTab;
}
...
public void setTermConTab(WebElement termConTab) {
	this.termConTab = termConTab;
}
...
public void setPaymentTermTab(WebElement paymentTermTab) {
	this.paymentTermTab = paymentTermTab;
}
...
public void setEditBtns(List<WebElement> editBtns) {
	this.editBtns = editBtns;
}
...
public void setDeleteBtns(List<WebElement> deleteBtns) {
...
public void setDraftBtn(WebElement draftBtn) {
...
public void setUpdateSuccMsg(WebElement updateSuccMsg) {
	this.updateSuccMsg = updateSuccMsg;
}
...
public void setSgstLabel(WebElement sgstLabel) {
	this.sgstLabel = sgstLabel;
}
...
public void setCgstLabel(WebElement cgstLabel) {
	this.cgstLabel = cgstLabel;
}
