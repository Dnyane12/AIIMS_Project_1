...
public class DebitNotePage {
	WebDriver driver;
	private static final Logger logger = LogManager.getLogger(DebitNotePage.class);	
		...
		@FindBy(xpath="(//igx-nav-drawer[contains(@id,'project-menu')]//span[contains(normalize-space(.),'Debit Note')])[1]")
		private WebElement debitNoteLink;
		...
		public void clickDebitNoteLink() {
			WaitHelper.waitForInvisibilityOfElementLocated(driver, dotSpinner, 20);
			WaitHelper.waitForClickable(driver,debitNoteLink, 20);
			debitNoteLink.click();
		}
...
//		}
		...
		public WebElement getDebitNoteLink() {
			return debitNoteLink;
		}
