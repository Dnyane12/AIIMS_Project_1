...
public class CashReceiptPage {
	WebDriver driver;
	private static final Logger logger = LogManager.getLogger(CashReceiptPage.class);	
		...
		@FindBy(xpath="(//igx-nav-drawer[contains(@id,'project-menu')]//span[contains(normalize-space(.),'Cash Reciept')])[1]")
		private WebElement cashReceiptLink;
		...
		public void clickCashReceiptLink() {
			WaitHelper.waitForInvisibilityOfElementLocated(driver, dotSpinner, 20);
			WaitHelper.waitForClickable(driver,cashReceiptLink, 20);
			cashReceiptLink.click();
		}
...
//		}
		...
		public WebElement getCashReceiptLink() {
			return cashReceiptLink;
		}
