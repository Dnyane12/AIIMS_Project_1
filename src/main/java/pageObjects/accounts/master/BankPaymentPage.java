...
private static final Logger logger = LogManager.getLogger(BankPaymentPage.class);	
	...
	@FindBy(xpath="(//igx-nav-drawer[contains(@id,'project-menu')]//span[contains(normalize-space(.),'Bank Payment')])[1]")
	private WebElement bankPaymentLink;
	...
	public void clickBankPaymentLink() {
		WaitHelper.waitForInvisibilityOfElementLocated(driver, dotSpinner, 20);
		WaitHelper.waitForClickable(driver,bankPaymentLink, 20);
	...
	public void enterCheckNo(String checkNoLabel,String checkNoInputIdPart,String checkNoValue) {
		WaitHelper.waitForInvisibilityOfElementLocated(driver, dotSpinner,20);
		WaitHelper.waitForClickable(driver, checkNoField, 20);
...
//	}
	...
	public WebElement getBankPaymentLink() {
		return bankPaymentLink;
	}
