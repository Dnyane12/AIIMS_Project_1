...
public class CreditNotePage {
	WebDriver driver;
	private static final Logger logger = LogManager.getLogger(CreditNotePage.class);	
		...
		@FindBy(xpath="(//igx-nav-drawer[contains(@id,'project-menu')]//span[contains(normalize-space(.),'Credit Note')])[1]")
		...
		public void clickCreditNoteLink() {
			WaitHelper.waitForInvisibilityOfElementLocated(driver, dotSpinner, 20);
			WaitHelper.waitForClickable(driver,creditNoteLink, 20);
...
//		}
		...
		public WebElement getCreditNoteLink() {
			return creditNoteLink;
		}
